...
# 强制指定异步后端，解决 anyio.NoEventLoopError
os.environ["ANYIO_BACKEND"] = "asyncio"

# 新版 Google GenAI SDK (替代已废弃的 generativeai)
...
# ---------- 配置 API Keys（从 Streamlit secrets 读取）----------
# 需要在 .streamlit/secrets.toml 中设置：
# GEMINI_API_KEY = "your_key"
# DEEPSEEK_API_KEY = "your_key"
# 如果不用 FinMind，可以不设 FINMIND_TOKEN
...
# ---------- 台股數據抓取（移除 FinMind，改用 yfinance 作為備援）----------
...
st.caption("台股升級：盤中採用證交所官方即時報價，盤後採用 Yahoo Finance 歷史數據。")
